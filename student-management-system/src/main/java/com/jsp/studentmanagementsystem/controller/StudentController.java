...
import com.jsp.studentmanagementsystem.util.CsvFileGenerator;
...
public class StudentController {
	...
	public ResponseEntity<String> sendMimeMessage(@RequestBody MessageData messageData)throws MessagingException
	{
	 ...
	 @PostMapping("/export-to-csv")
	  public  ResponseEntity<String> extractFromCsv(@RequestParam  MultipartFile file) throws IOException {
			return service.extractFromCsv(file);	

	   // response.setContentType("text/csv");
	   // response.addHeader("Content-Disposition", "attachment; filename=\"student.csv\"");
//	    csvGenerator.writeStudentsToCsv(service.getStudentOfList();
	  }
